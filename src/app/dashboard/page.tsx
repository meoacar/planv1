          ...
          <div className="space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/20 dark:border-slate-800/50 p-6 shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Link href="/ai-features" className="group p-4 rounded-xl bg-gradient-to-br from-purple-500 to-blue-600 hover:shadow-lg transition-all hover:scale-105 border-2 border-purple-400/30">
                  <span className="text-2xl mb-2 block">🤖</span>
                  <p className="text-xs font-semibold text-white">AI Önerileri</p>
                </Link>
